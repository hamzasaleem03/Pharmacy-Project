...
function index() {
  return (
    <>
      <div className= "xl:pl-60  relative px-4 mt-10">
        <p className="text-2xl font-bold text-center xl:hidden block">社長の日報</p>
        <div className="relative py-12">
          <p className="xl:block hidden w-6 text-2xl font-bold text-gray-700 uppercase absolute 2xl:-left-5 -left-20 2xl:top-[130px] top-[120px] z-10">社長の日報</p>
          <div className="py-4">
            <div aria-label="one">
              <div className="py-7">
